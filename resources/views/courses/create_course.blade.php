        ...
        <div class="col-md-6">
            <div class="card card_style">
                ...
                <div class="card-body">
                    ...
                    <h4 class="register_header ml-5">Course</h4>

                    <form class="mt-4" action="{{route('course.new')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-md-10">
                                <input type="text" class="form-control form-control-sty" name="video_link" value="{{ old('video_link') }}" placeholder="Youtube playlist or Dropbox link">
                            </div>
                        </div>
